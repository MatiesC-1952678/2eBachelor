  ...
  <?php include("php/header.php") ?>
    ...
    <div class="loginPage">
      ...
      <form id="userS" class="userLogin" action="php/userLogin.php" method="post">
        ...
        <!-- enterprise login -->
      <form id="enterpriseS" class="enterpriseLogin" action="php/enterpriseLogin.php" method="post">
      ...
      <p> * these fields are necessary when registering </p>
      <p> ** these fields are necessary when login in and registering </p>
    </div>

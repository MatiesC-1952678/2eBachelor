...
#include <memory>
#include "../Oefening1/CG1_DrawTool.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CG1_DrawTool_t, stringdata0) + ofs \
...
void CG1_DrawTool::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CG1_DrawTool *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CG1_DrawTool::*)(int , int , RGB_Color );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CG1_DrawTool::PutPixel)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CG1_DrawTool::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CG1_DrawTool::UpdateWindow)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CG1_DrawTool::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_CG1_DrawTool.data,
    qt_meta_data_CG1_DrawTool,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CG1_DrawTool::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CG1_DrawTool.stringdata0))

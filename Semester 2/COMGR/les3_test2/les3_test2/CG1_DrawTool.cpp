...
void CG1_DrawTool::DrawData()
{
    ...
    i += 0.05f;
    ModelViewMatrix.RotateX(i*5);
    ModelViewMatrix.RotateZ(i);
    //ModelViewMatrix.RotateY(i);
    //ModelViewMatrix.RotateZ(i);
    ModelViewMatrix.Translate(-Camera_X, -Camera_Y, -Camera_Z);
	//INITIALISEER DE PROJECTIEMATRIX
    ProjectionMatrix.SetPerspectiveProjection(-200);

    //DrawUnitCube(RGB_Color(1.0, 0.0, 0.0));
    ...
    point1.SetXYZW(-50, 0, 0, 1);
    point2.SetXYZW(50, 0, 0, 1);
    point3.SetXYZW(0, 100, 0, 1);
    point4.SetXYZW(0, 0, 50, 1);

    point1 = ProjectionMatrix * point1;
    point2 = ProjectionMatrix * point2;
    point3 = ProjectionMatrix * point3;
    point4 = ProjectionMatrix * point4;
    point1 = ModelViewMatrix * point1;
    point2 = ModelViewMatrix * point2;
    point3 = ModelViewMatrix * point3;
    point4 = ModelViewMatrix * point4;

    Draw3DLine(point1, point2, RGB_Color(1, 0, 0));
    Draw3DLine(point1, point3, RGB_Color(0, 1, 0));
    Draw3DLine(point3, point2, RGB_Color(0, 0, 1));
    Draw3DLine(point1, point4, RGB_Color(1, 0, 0));
    Draw3DLine(point2, point4, RGB_Color(0, 1, 0));
    Draw3DLine(point3, point4, RGB_Color(0, 0, 1));


    /*
    CG1_4DVector start;
    CG1_4DVector end;
    start.SetXYZW(-100, 50, 0, 1);
    end.SetXYZW(100, 10, 0, 1);
    ...
    CG1_4DVector start1, end1;
    start1.SetXYZW(100, 10, 0, 1);
    end1.SetXYZW(200, 40, 100, 1);
    start1 = ModelViewMatrix * start1;
    end1 = ModelViewMatrix * end1;
    start1 = ProjectionMatrix * start1;
    end1 = ProjectionMatrix * end1;

    CG1_4DVector start2, end2;
    start2.SetXYZW(-100, 50, 0, 1);
    end2.SetXYZW(200, 40, 100, 1);
    start2 = ModelViewMatrix * start2;
    end2 = ModelViewMatrix * end2;
    start2 = ProjectionMatrix * start2;
    end2 = ProjectionMatrix * end2;

    CG1_4DVector start3;
    start3.SetXYZW(200, 100, 50, 1);
    start3 = ModelViewMatrix * start3;
    start3 = ProjectionMatrix * start3;


    Draw3DLine(start2, end2, RGB_Color(1.0, 0.0, 0.0));
    Draw3DLine(start1, end1, RGB_Color(0.0, 1.0, 0.0));
    Draw3DLine(start, end, RGB_Color(0.0, 0.0, 1.0));
    Draw3DLine(start3, end1, RGB_Color(0.0, 0.0, 0.0));
    Draw3DLine(start3, end2, RGB_Color(0.0, 0.0, 0.0));
    Draw3DLine(start3, end, RGB_Color(0.0, 0.0, 0.0));
    Draw3DLine(start2, start3, RGB_Color(0.0, 0.0, 0.0));
    */


    //ASSENSTELSEL TEKENEN
    /*
    CG1_4DVector begin, stop;
    begin.SetXYZW(-100, 0, 0, 1);
    stop.SetXYZW(100, 0, 0, 1);
    Draw3DLine(begin, stop, RGB_Color(1.0f, 0.0f, 0.0f));
    begin.SetXYZW(0, 100, 0, 1);
    stop.SetXYZW(0, -100, 0, 1);
    Draw3DLine(begin, stop, RGB_Color(0.0f, 1.0f, 0.0f));
    begin.SetXYZW(0, 0, 100, 1);
    stop.SetXYZW(0, 0, -100, 1);
    Draw3DLine(begin, stop, RGB_Color(0.0f, 0.0f, 1.0f));
    */

...
void PlanetsView::paintGL()
{
    ...
    glRotated( (GLdouble)(360.0 * dayOfYear /250.0), 0.0, 1.0, 0.0 );
    ...
    glRotated ( 5.0, 1.0, 0.0, 0.0 );
    glTranslated( (-1*dayOfYear)%100, 0 /*(-1*dayOfYear)%100*/, /*(-1*dayOfYear)%100*/ 0);
    glTranslated( 15, 0, -5 );
    GLfloat diff3 [] = { 0.7f , 0.0f , 0.0f };
    glMaterialfv ( GL_FRONT, GL_DIFFUSE, diff3 );
    Util::drawSolidSphere(1.0, 5, 5);
